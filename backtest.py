...
from strate.exchange import ExchangeAPI
from strate.utils import read_file, assert_msg
from strate.strategy import SmaCross
...
def main():
    ...
    print(BTCUSD.Close, type(BTCUSD))
    # print(BTCUSD)
